...
class NotificationService {
  ...
  static Future<void> initialiser() async {
    ...
    try {
      ...
      // ignore: avoid_print
      print('[Pakt] Permission notifications : ${reglages.authorizationStatus}');
      ...
      FirebaseMessaging.onMessage.listen((message) {
        // ignore: avoid_print
        print('[Pakt] Notification reçue au premier plan : ${message.notification?.title}');
      ...
      // ignore: avoid_print
      print('[Pakt] Initialisation FCM impossible pour le moment : $e');
    }
  }

  static Future<void> _gererClicNotification(RemoteMessage message) async {
    // ignore: avoid_print
    print('[Pakt] Notification ouverte : ${message.data}');
  ...
  static Future<void> _enregistrerToken({bool reessaieDeja = false}) async {
    try {
      ...
      final token = kIsWeb
          ...
          : await _messaging.getToken();
      // ignore: avoid_print
      print('[Pakt] Token FCM obtenu : ${token != null}');
      ...
      // ignore: avoid_print
      print('[Pakt] Token FCM enregistré dans device_tokens.');
    } catch (e) {
      ...
      // ignore: avoid_print
      print("[Pakt] Impossible d'enregistrer le token FCM : $e");
    }
  }
