...
- Identifiants Firebase/stores/package non renommés en cohérence avec "Pakt" (décision volontairement reportée) : iOS `com.kevinarner.lePacte`, Android `com.kevinarner.le_pacte`, projet Firebase `le-pacte-e6c17`.
